...
#Define residual layer first , used for stage 6
def resBlock(x,filterNum=16):
    x=Conv2D(filterNum,kernel_size=(3,3), strides=(1,1),padding="same",activation='relu')(x)
    x1=Conv2D(filterNum,kernel_size=(3,3), strides=(1,1),padding="same",activation='relu')(x)
    x=add([x,x1])
    return x
...
modelname="map_network_resnet_new"
